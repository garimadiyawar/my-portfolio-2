...
export default function Portfolio() {
  ...
  return (
    <div style={{background:'var(--page)',minHeight:'100vh',width:'100%',maxWidth:'100%',overflowX:'hidden'}}>
      ...
      {/* ══ HERO ══ */}
      <div id="home" style={{padding:'0 0 40px 0',minHeight:'100vh',backgroundImage:"url('/6.jpg')",backgroundSize:'420px 100%',backgroundRepeat:'repeat-x',backgroundPosition:'left center',display:'flex',justifyContent:'center',alignItems:'center'}}>
      ...
      {/* ══ ABOUT ══ */}
      <div id="about" style={{padding:'20px 0 0 0',backgroundImage:"url('/6.jpg')",backgroundSize:'420px 100%',backgroundRepeat:'repeat-x',backgroundPosition:'left center'}}>
      ...
      {/* ══ SKILLS ══ */}
      <div id="skills" style={{padding:'60px 48px',minHeight:'100vh',backgroundImage:"url('/6.jpg')",backgroundSize:'420px 100%',backgroundRepeat:'repeat-x',backgroundPosition:'left center',display:'flex',justifyContent:'center',alignItems:'center'}}>
      ...
      {/* ══ PROJECTS ══ */}
      <div id="projects" style={{padding:0,backgroundImage:"url('/6.jpg')",backgroundSize:'420px 100%',backgroundRepeat:'repeat-x',backgroundPosition:'left center'}}>
      ...
      {/* ══ ML LAB ══ */}
      <div id="demo" style={{padding:0,minHeight:'100vh',backgroundImage:"url('/6.jpg')",backgroundSize:'420px 100%',backgroundRepeat:'repeat-x',backgroundPosition:'left center',display:'flex',justifyContent:'center',alignItems:'center'}}>
      ...
      {/* ══ GITHUB ══ */}
      <div id="github" style={{padding:0,backgroundImage:"url('/6.jpg')",backgroundSize:'420px 100%',backgroundRepeat:'repeat-x',backgroundPosition:'left center'}}>
